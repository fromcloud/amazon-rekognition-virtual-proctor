...
Resources:
  ...
  IndexFaceFunction:
    ...
    Properties:
      ...
      CodeUri: s3://solution-builders-us-west-2/amazon-rekognition-virtual-proctor/v0.8/89a4e518746c7e5dd2963cd00ee0a899
      Events:
        Get:
          Type: Api
          Properties:
  ...
  LambdaSetup:
    ...
    Properties:
      ...
      CodeUri: s3://solution-builders-us-west-2/amazon-rekognition-virtual-proctor/v0.8/f5ea2429475b57a4ac9f8a5674c23362
